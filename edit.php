...
$donnee =$bdd->prepare("SELECT * FROM chambre WHERE id =$name");
$donnee->execute();
  ...
  <html>
    ...
    <body>
      ...
      if(isset($_POST['new']) && $_POST['new']==1){
        ...
        $update=$bdd->prepare("UPDATE chambre SET titre='".$titre."',description='".$description."',source_image='".$source_image."' WHERE id=$id");
        $update->execute();
      ...
      echo '<p style="color:#FF0000;">'.$status.'</p>';*/
        ...
        <div class="form-group form-group-style">
            <label>Entrer le titre de la chambre</label>
            <input type="text" name="titre" class="form-control" placeholder="Entrer le Titre de la chambre" required value="<?php echo $titre;?>" />
        </div>
        ...
        <label>Entrer le prix</label>
          <input type="text" name="prix" class="form-control" placeholder="Entrer le prix" required value="<?php echo $prix;?>" />
        </div>
