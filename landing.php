<?php
   ...
   // si la session existe pas soit si l'on est pas connecté on redirige
    ...
    $donnee =$bdd->prepare('SELECT * FROM etablissement');
    $donnee->execute();
...
<body>
    ...
    <?php 
        if(isset($idetablissement[0])){
        ?>
        <form method='POST' action='editetablissement.php' class="card border-0">
            <img class="card-img-top" src="<?php echo $imagechambre[0]?>" alt="Card image cap">
            <div class="card-body">
              <a href="etablissementparis.php"><h5 class="card-title"><?php echo $titre[0]; ?></h5></a>
        ...
        <?php 
        if(isset($idetablissement[1])){
        ?>
        <form method='POST' action='editetablissement.php' class="card border-0">
            <img class="card-img-top" src="<?php echo $imagechambre[1]?>" alt="Card image cap">
            <div class="card-body">
            <a href="etablissementmontpellier.php"><h5 class="card-title"><?php echo $titre[1]; ?></h5></a>
    ...
    <?php 
        if(isset($idetablissement[2])){
        ?>
        <form method='POST' action='editetablissement.php' class="card border-0">
            <img class="card-img-top" src="<?php echo $imagechambre[1]?>" alt="Card image cap">
            <div class="card-body">
            <a href="etablissementbordeaux.php"><h5 class="card-title"><?php echo $titre[2]; ?></h5></a>
          ...
          <?php 
        if(isset($idetablissement[3])){
        ?>
        <form method='POST' action='editetablissement.php' class="card border-0">
            <img class="card-img-top" src="<?php echo $imagechambre[1]?>" alt="Card image cap">
            <div class="card-body">
            <a href="etablissementbrest.php"><h5 class="card-title"><?php echo $titre[3]; ?></h5></a>
...
<?php 
    if(isset($idetablissement[4])){
    ?>
    <form method='POST' action='editetablissement.php' class="card border-0">
        <img class="card-img-top" src="<?php echo $imagechambre[1]?>" alt="Card image cap">
        <div class="card-body">
        <a href="etablissementcanne.php"><h5 class="card-title"><?php echo $titre[4]; ?></h5></a>
          <p class="card-text"><?php echo $description[4];?></p>
      ...
      <?php 
    if(isset($idetablissement[5])){
    ?>
    <form method='POST' action='editetablissement.php' class="card border-0">
        <img class="card-img-top" src="<?php echo $imagechambre[1]?>" alt="Card image cap">
        <div class="card-body">
        <a href="etablissementnice.php"><h5 class="card-title"><?php echo $titre[5]; ?></h5></a>
          <p class="card-text"><?php echo $description[5];?></p>
...
<?php 
    if(isset($idetablissement[6])){
    ?>
    <form method='POST' action='editetablissement.php' class="card border-0">
        <img class="card-img-top" src="<?php echo $imagechambre[1]?>" alt="Card image cap">
        <div class="card-body">
        <a href="etablissementstrasbourg.php"><h5 class="card-title"><?php echo $titre[6]; ?></h5></a>
          <p class="card-text"><?php echo $description[6];?></p>
