...
<script src="https://code.jquery.com/jquery-3.5.1.slim.min.js"></script>
    ...
    <form action="reservation_traitement.php" method="post" class ="form-style">
        ...
        <div class="form-group form-group-style">
            <label>Entrer la chambre</label>
            <input type="text" name='chambre' class="form-control" placeholder="date de départ" value="<?php if(isset($titre)){echo $titre;} ?>" required>
        </div>
        ...
        <div class="index">
            Les jours en rouge ne sont plus disponible
        </div>
        <?php
        if(isset($name)){
        $count1=count($test);
